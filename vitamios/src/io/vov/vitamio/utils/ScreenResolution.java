...
public class ScreenResolution {
   ...
   * */
  @SuppressLint("NewApi") public static Pair<Integer,Integer> getResolution(Context ctx){
   ...
   * */
  @SuppressLint("NewApi") private static Pair<Integer, Integer> getRealResolutionOnOldDevice(Context ctx) {
    try{
