...
public class NewsSlidingMain extends SlidingFragmentActivity implements
		onMenuClickListener, OnTitleBarClickListener {
	// 声明Menu
	...
	private void initSlidingMenu() {
		...
		getSupportFragmentManager().beginTransaction()
				.replace(R.id.content_framelayout, nmfU).commit();
		...
		getSupportFragmentManager().beginTransaction()
				.replace(R.id.menu_frame_layout, new LeftSlidingMenuFragment())
				.commit();
		// 设置滑动菜单的的视图界面
	...
	public void onMenuClick(View v) {
		...
		case R.id.news_weather_layout:
			...
			// Intent intentWeather=new
			// Intent("scxh.intent.action.weatherShow");
