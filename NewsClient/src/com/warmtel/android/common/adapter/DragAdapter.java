package com.warmtel.android.common.adapter;
...
public class DragAdapter extends BaseAdapter {
    ...
    /** 添加频道列表 */
    public List<ChannelItem> addItem(ChannelItem channel) {
    ...
    /** 拖动变更频道排序 */
    public List<ChannelItem> exchange(int dragPostion, int dropPostion) {
    ...
    /** 删除频道列表 */
    public List<ChannelItem> remove() {
